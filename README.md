...
👯 Excited to collaborate on open source projects! Particularly drawn to fun endeavors like game projects and innovative mobile applications.

🤝 Seeking guidance on my quest to become a true master of the craft in web and mobile development. Any insights and mentorship are highly valued! (^ ^)

🌱 Currently immersed in the world of Flutter, while fine-tuning my skills in Angular and Spring Boot.

⚡ Fun fact: I'm a hardcore gaming fan? My enthusiasm for coding is mostly rivaled by my love for epic gaming adventures. Let's code and game on! 🎮✨

### SKILLS 💻
- **Programming Languages:** 
  <br> ![TypeScript Icon](https://img.icons8.com/color/48/000000/typescript.png) ![Java Icon](https://img.icons8.com/color/48/000000/java-coffee-cup-logo.png) ![Dart Icon](https://img.icons8.com/color/48/000000/dart.png)
...
- **Backend Development:** 
  <br> ![Spring Boot Icon](https://img.icons8.com/color/48/000000/spring-logo.png) ![NGINX Icon](https://img.icons8.com/color/48/000000/nginx.png)

- **Mobile Applications Development:** 
  <br> ![Flutter Icon](https://img.icons8.com/color/48/000000/flutter.png)
...
[![LeetCode Icon](https://img.icons8.com/color/24/000000/source-code.png)](https://leetcode.com/eeryy "Leetcode profile")&ensp;
